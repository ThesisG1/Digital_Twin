...
vel_sub = rospy.Subscriber('/mavros/local_position/velocity_local',TwistStamped , cmd_vel_callback)
acc_sub = rospy.Subscriber('/imu', Imu , acc_callback)
temp_sub = rospy.Subscriber('/mavros/imu/temperature_imu', Temperature , temp_callback)
pres_sub = rospy.Subscriber('/mavros/imu/static_pressure', FluidPressure , pres_callback)
